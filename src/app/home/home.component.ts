...
export class HomeComponent {
  ...
  ngOnInit() {
    this.http.get('/api/products/getNewArrivals').subscribe(
      (res: any) => {
  ...
  images = [1, 2, 3, 4].map(
    (n) => `../assets/images/home_images/slide${n}.png`
  );
  ...
  navTo(url: string, param: string) {
    this.router.navigate([url], { queryParams: { Category: param } });
  }
}
