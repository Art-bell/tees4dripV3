...
export class ItemPageComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.paramMap.subscribe((params: ParamMap) => {
      ...
      this.http.get('/api/products/findByPk', {headers:queryHeaders, params: queryParams}).subscribe((res) => {this.currentProduct = res; console.log(res)}, (err) => {console.error(err)});
      // Get suggestions.
