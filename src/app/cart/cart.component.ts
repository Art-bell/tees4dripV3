...
import { ViewEncapsulation, Component, OnInit, ViewChild, HostListener } from '@angular/core';
...
export class CartComponent implements OnInit {
  ...
  removeItem(index: number, productId: number, name: string) {
    ...
    this.http.post('/api/removeFromCart', {userToken: this.userService.getUserToken(), productId}).subscribe((res:any) => {
  ...
  public get cartTotal() {
    return this.cartSubTotal + this.estimatedShipping;
  }
}
