...
export class CartComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private userService: UserService) {
    this.userService.getCartItemsSubject().subscribe((cartItems) => {
      this.cartItems = cartItems;
    });
    this.userService.getLoadingSubject().subscribe((loading) => {
  ...
  ngOnInit(): void {
    ...
    // Get suggestions.
    this.http
      .get('/api/products/productResults', { params: { limit: 8 } })
      .subscribe((res: any) => {
  ...
  public get isLoading() {
    return this.loading || this.cartLoading;
  }
}
